...
def main():
    ...
    create_parser.add_argument("--sell-max", type=float, default=0, help="Max price to place SELL orders (0 = no limit)")
    create_parser.add_argument("--sell-min", type=float, default=0, help="Min price to place SELL orders (0 = no limit)")
    create_parser.add_argument("--buy-max", type=float, default=0, help="Max price to place BUY orders (0 = no limit)")
    create_parser.add_argument("--buy-min", type=float, default=0, help="Min price to place BUY orders (0 = no limit)")
